...
#C1
G.add_edge("B-01", "C1", path="Walk till you see this corridor")
G.add_edge("B-02", "C1", path="Walk till you see this corridor")
G.add_edge("B-03", "C1", path="Walk till you see this corridor")
G.add_edge("B-04", "C1", path="Walk till you see this corridor")
G.add_edge("B-05", "C1", path="Walk till you see this corridor")
G.add_edge("B-08", "C1", path="Walk till you see this corridor") 
#Reverse C1
G.add_edge("C1", "B-01")
G.add_edge("C1", "B-02")
G.add_edge("C1", "B-03")
